...
const data2025={
 credit:{
  ...
  BBCA:[893.03,900.66,930.13,923.10,924.26,929.538706,923.512447,null],
  BBNI:[749.82,741.99,750.42,757.58,755.45,763.256772,763.655355,null],
 ...
 profit:{
  ...
  BBCA:[4.73,8.98,14.15,20.21,25.16,29.890278,34.707591,null],
  BBNI:[1.63,3.29,5.38,6.87,8.45,10.140022,11.870495,null],
...
const data2026={
 credit:{
  ...
  BBCA:[948.96,953.22,980.59,965.02,969.10,1003.728384,1000.882825,null],
  BBNI:[894.29,882.22,903.34,919.50,940.88,952.842960,969.943871,null],
 ...
 profit:{
  ...
  BBCA:[5.00,9.23,14.69,20.82,25.68,30.191956,35.252398,null],
  BBNI:[1.69,3.42,5.65,7.29,9.05,10.907257,12.527978,null],
  BNGA:[0.58,1.07,1.73,2.28,2.71,3.190910,3.453804,null],
  NISP:[0.44,0.86,1.36,1.82,2.26,2.730119,3.215509,null]
 }
};
const state={selectedBank:'BMRI',creditChart:null,profitChart:null,valuationEntity:'PORTFOLIO',valuationData:null,peBandChart:null,pbvBandChart:null};
...
function renderCharts(){
 ...
 const notes={
  ...
  BMRI:'BMRI is available through August 2026, compared with August 2025. Profit is cumulative January–August; other banks are available through July.',
